...
# except Exception as e: # COMMENT OUT OR REMOVE THIS LINE
#     logger.error(f"Error connecting to Google Sheet: {e}") # COMMENT OUT OR REMOVE THIS LINE
#     sheet = None # COMMENT OUT OR REMOVE THIS LINE
